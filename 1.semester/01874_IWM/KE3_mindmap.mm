...
<node CREATED="1435598456314" ID="ID_735945649" MODIFIED="1435598500788" TEXT="KE3">
<node CREATED="1435598517029" ID="ID_1660888584" MODIFIED="1435603516507" POSITION="right" TEXT="1. Einleitung">
...
<richcontent TYPE="NOTE"><html>
  ...
  <body>
    <p>
      ein Filter entfernt irrelevante Informationen eines ankommenden Datenstromes oder Wissensressourcen, die auch in unstrukturierter
    </p>
    <p>
...
<richcontent TYPE="NOTE"><html>
  ...
  <body>
    <p>
      um Benutzer bei der Erledigung
    </p>
    <p>
      ihrer derart gestalteten Informationsaufgaben zu unterst&#252;tzen.
    </p>
    <p>
      
    </p>
    <p>
      Benutzungsschnittstellen von so genannten Informationssystemen arbeiten als Vermittler zwischen benutzerdefinierten Problemfeldern informationeller Natur und deren effizienter L&#246;sung durch automatische Gewinnung von Information
    </p>
    <p>
...
<node CREATED="1435603789325" ID="ID_78296538" MODIFIED="1435603805074" TEXT="Bewertung der Verwendbarkeit"/>
</node>
<node CREATED="1435598526978" ID="ID_67943602" MODIFIED="1435600099866" TEXT="1.1 Datenmodelle und Datenbanksysteme">
<node CREATED="1435607656689" ID="ID_483358476" MODIFIED="1435607673748" TEXT="Datenbanksystem">
<richcontent TYPE="NOTE"><html>
  <head>
  ...
  <body>
    <p>
      ein Datenbanksystem (DBS) ein System zur
    </p>
    <p>
...
<richcontent TYPE="NOTE"><html>
  ...
  <body>
    <p>
      Zum andern handelt es sich um objektorientierte Datenbanksysteme, die mit einem vereinheitlichten Datenmodell arbeiten, das unabh&#228;ngig von
    </p>
    <p>
...
<node CREATED="1435687177914" ID="ID_1216099348" MODIFIED="1435687937277" POSITION="right" TEXT="2. Information-Retrieval-Modelle">
<richcontent TYPE="NOTE"><html>
  <head>
  ...
  <body>
    <p>
      Ein <i>Information-Retrieval-System</i>&#160;(IRS) extrahiert f&#252;r eine Problemstellung relevante d. h. aus Sicht der Benutzer und ihrer Anwendungsaufgabe informationstragende Daten aus einer gro&#223;en Datenmenge.
    </p>
    <p>
      
    </p>
    <p>
      Spricht man von <i>Information Retrieval,</i>&#160;so ist
    </p>
    <p>
...
<richcontent TYPE="NOTE"><html>
  ...
  <body>
    <p>
      das Verh&#228;ltnis zwischen der Gesamtzahl der auf eine
    </p>
    <p>
...
<node CREATED="1435688645207" ID="ID_480564824" MODIFIED="1435689106229" TEXT="Dokumentenrepr&#xe4;sentation">
<richcontent TYPE="NOTE"><html>
  <head>
...
<richcontent TYPE="NOTE"><html>
  ...
  <body>
    <p>
      eine Suchkomponente mittels derer nach bestimmten
    </p>
    <p>
...
<richcontent TYPE="NOTE"><html>
  ...
  <body>
    <p>
      - Es basiert auf exakter Erf&#252;llung einer Anfrage durch ein Dokument.
    </p>
    <p>
    ...
    <p>
      Die Datenbasis wird bez&#252;glich einer Anfrage in zwei Untermengen unterteilt:
    </p>
    <p>
      - in die Menge der als voll zutreffend zugelassenen
    </p>
    <p>
      - und in die Menge der als nicht zutreffend verworfenen Dokumente.
    </p>
    <p>
      
    </p>
    <p>
      Es findet keine Relevanzbewertung der Dokumente statt.
    </p>
  </body>
</html>
</richcontent>
<node CREATED="1435689918807" ID="ID_861212833" MODIFIED="1435689923627" TEXT="Anfrageterme"/>
<node CREATED="1435689924022" ID="ID_662445532" MODIFIED="1435689934508" TEXT="Boole&apos;sche Operatoren"/>
</node>
<node CREATED="1435691943136" ID="ID_1085180747" MODIFIED="1435692006413" TEXT="2.2 Best-Match-Modelle">
<richcontent TYPE="NOTE"><html>
  <head>
...
<richcontent TYPE="NOTE"><html>
  ...
  <body>
    <p>
      Beim so genannten linearen Ordnen (Linear Ordering) m&#252;ssen
    </p>
    <p>
...
<richcontent TYPE="NOTE"><html>
  ...
  <body>
    <p>
      ein Dokument als Vektor in einem mathematischen Raum, dem so genannten Inhaltsraum der Dokumentmenge, aufgefasst werden kann. Die inhaltliche Verwandtschaft von Dokumenten untereinander oder bez&#252;glich einer Anfrage kann durch den Abstand von Vektoren zum Ausdruck gebracht werden.
    </p>
    <p>
      
    </p>
    <p>
      Zentrale Eigenschaft dieses Modells ist die Ber&#252;cksichtigung der Relevanz eines Begriffes bez&#252;glich eines Dokumentes und der Relevanz eines Suchbegriffs bez&#252;glich der Anfrage.
    </p>
    <p>
      
    </p>
    <p>
      F&#252;r die Generierung der Vektoren stehen mehrere M&#246;glichkeiten zur
    </p>
    <p>
      Auswahl [44]:
    </p>
    <p>
      - So kann zum einen lediglich auf bin&#228;re Art und Weise entschieden werden, ob ein Term in einem Dokument vorkommt oder nicht. Nach dieser Methode besitzen alle Vektoren einer Datenbasis die gleiche Dimensionalit&#228;t und es wird lediglich vermerkt, ob ein Term in einem Dokument vorhanden ist oder nicht.
    </p>
    <p>
      - Die Alternative besteht in der Berechnung von Termgewichten. In der einfachsten Form w&#228;re dies eine Z&#228;hlung der Vorkommensh&#228;ufigkeit
    </p>
    <p>
      der einzelnen Terme im jeweiligen Dokument. Auf der Vorkommensh&#228;ufigkeit der einzelnen Terme beruhen auch ausgefeiltere Berechnungen
    </p>
    <p>
      von Termgewichten, die im einfachsten Fall lediglich eine Normalisierung der Werte des oben beschriebenen Vektors erbringen, meist jedoch auf komplexeren Algorithmen beruhen und beispielsweise die Vorkommensh&#228;ufigkeit eines Terms in der gesamten Datenbasis mit einbeziehen. Je n&#228;her in einem solchen Fall das
    </p>
    <p>
...
<node CREATED="1435695412928" ID="ID_813860601" MODIFIED="1435781067242" TEXT="2.2.4 Probabilistische Modelle">
<richcontent TYPE="NOTE"><html>
  <head>
  ...
  <body>
    <p>
      mit Mitteln der Wahrscheinlichkeitsrechnung abgesch&#228;tzt wird, wie gut ein Dokument das Benutzerinteresse erf&#252;llt. Statistische Verteilungen
    </p>
    <p>
...
<node CREATED="1435695449095" ID="ID_688642520" MODIFIED="1435862819007" TEXT="2.3 Relevance-Feedback-Modelle">
<richcontent TYPE="NOTE"><html>
  <head>
  ...
  <body>
    <p>
      Mitte der sechziger Jahre ist das Relevance Feedback als kontrollierter, automatischer Prozess der Anfrageumformulierung eingef&#252;hrt worden, der
    </p>
    <p>
      verbesserte Anfrageformulierungen auf der Basis einer Einstiegssuche erzeugt [44]. Beim Relevance Feedback handelt es sich also im Grunde um keine
    </p>
    <p>
